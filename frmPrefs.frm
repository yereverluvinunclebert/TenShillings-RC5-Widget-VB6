...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\TenShillings-RC5-Widget-VB6MkII\TenShillings-RC5-Widget-VB6.vbp"
...
'    End If
    ...
    If gblStartup = "1" Then
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "TenShillingsRC5WidgetVB6", """" & App.Path & "\" & "TenShillings-RC5-Widget-VB6.exe""")
    Else
        Call writeRegistry(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "TenShillingsRC5WidgetVB6", vbNullString)
    End If
...
Private Sub adjustPrefsControls(Optional ByVal restartState As Boolean)
    ...
    lblGitHub.Caption = "You can find the code for the TenShillings Widget on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/TenShillings-RC5-Widget-" & gblCodingEnvironment
