...
Option Explicit 'simple "drop-in" regfree-module for RichClient (in the IDE it will use the registered version, but as Exe will require a \Bin\-Subfolder with all RichClient-Dlls)
...
Private Const RCDllRelPath  As String = "\Bin\vbRichClient5.dll"
...
Public Function New_W(ClassName As String, Optional DllName As String = "vbWidgets.dll") As Object
